...
class DrumMachine extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement(DrumPadBank, { currentDrumPadBank: this.state.currentDrumPadBank, displayName: this.displayName }))));
...
class DrumPadBank extends React.Component {
  ...
  render() {
    let padBank = this.props.currentDrumPadBank.map((drumObj, i, drumPadBankOne) => {
      return /*#__PURE__*/(
        React.createElement("div", { className: "container" }, /*#__PURE__*/
        React.createElement(DrumPad, { clip: drumPadBankOne[i].src, name: drumPadBankOne[i].name, keyCode: drumPadBankOne[i].keyCode, keyTrigger: drumPadBankOne[i].keyTrigger, color: drumPadBankOne[i].color, displayName: this.props.displayName })));


    });
    return /*#__PURE__*/React.createElement("div", { id: "drumPadBank" }, padBank);
  }}
...
class DrumPad extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("div", { className: "drum-pad", id: this.props.name, onClick: this.playSound, style: this.state.buttonStyle }, /*#__PURE__*/
...
class Application extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement(DrumMachine, null), /*#__PURE__*/
